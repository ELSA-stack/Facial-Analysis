...
const measurements = Object.entries(data.measurements || {}).map(
  ...
  description: 'Overall facial attractiveness score calculated from facial proportions and symmetry.',
},
{
  title: 'Face Shape',
  value: summaryFaceShape,
  description: 'Detected face shape using MediaPipe facial landmark analysis.',
},
{
  title: 'Facial Symmetry',
  value: summarySymmetry,
  description: 'Measures how balanced the left and right sides of the face are.',
},
{
  title: 'Confidence Score',
  value: summaryConfidence,
  description: 'Confidence of the face shape prediction based on the detected facial landmarks.',
},
          ].map((item, index) => (
